...
```{r}
NWP_quant_rew25_1993_2023_1 = get_all_NWP_quantiles(path = "/mn/kadingir/datascience_000000/eirikhsj/sfe_nordic_temperature/",
...
#scp   eirikhsj@abacus-as.uio.no:~/rew_k_23_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_24_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_25_3.Rda /Users/Eirik/Desktop/Master2023/Output_data/Reweighted_data            
eirikhsj@abacus-as.uio.no:~/rew_k_1_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_2_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_2_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_3_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_4_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_5_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_6_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_7_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_8_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_9_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_10_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_11_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_12_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_13_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_14_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_15_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_16_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_17_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_18_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_19_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_20_3.Rda  eirikhsj@abacus-as.uio.no:~/rew_k_20_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_21_3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_22_3.Rda
...
scp  eirikhsj@abacus-as.uio.no:~/rew_k_1_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_2_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_3_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_4_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_5_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_6_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_7_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_8_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_9_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_10_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_11_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_12_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_13_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_14_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_15_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_16_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_17_int3.Rda /Users/Eirik/Desktop/Master2023/Output_data/Reweighted_data 

scp eirikhsj@abacus-as.uio.no:~/rew_k_18_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_19_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_20_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_21_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_22_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_23_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_24_int3.Rda eirikhsj@abacus-as.uio.no:~/rew_k_25_int3.Rda /Users/Eirik/Desktop/Master2023/Output_data/Reweighted_data 

# Run models:  y = B interactions
```{r}
#For 1 days of re-weighting
for (k in 1:25){
    ERA_NWP = get_ERA_NWP(ERA_path = "/mn/kadingir/datascience_000000/eirikhsj/PC_ERA_79_92.Rda",
...
p = ggplot() +
    geom_line(data = ERA_NWP_RQE1[date>=as.Date("2007-01-01") & lead_time>60 & lead_time<=120, .(mean_test_loss = mean(mean_loss_1_5)), keyby = lead_time], aes(x = lead_time, y = mean_test_loss, col = 'K5'),alpha = 1)+
    geom_line(data = ERA_NWP_RQE1[date>=as.Date("2007-01-01") & lead_time>60 & lead_time<=120, .(mean_test_loss = mean(mean_loss_1_10)), keyby = lead_time], aes(x = lead_time, y = mean_test_loss, col = 'K10'),alpha = 1)+
    geom_line(data = ERA_NWP_RQE1[date>=as.Date("2007-01-01") & lead_time>60 & lead_time<=120, .(mean_test_loss = mean(mean_loss_1_15)), keyby = lead_time], aes(x = lead_time, y = mean_test_loss, col = 'K15'),alpha = 1)+
    
    geom_line(data = ERA_NWP_RQE1[date>=as.Date("2007-01-01") & lead_time>60 & lead_time<=120, .(mean_test_loss = mean(mean_loss_1_25)), keyby = lead_time], aes(x = lead_time, y = mean_test_loss, col = 'K25'),alpha = 1)+
    geom_line(data = Clima[lead_time <121, mean(pinball_loss(0.9, clima_pred90, PC1)), by = lead_time], aes(x = lead_time, y = V1, col = 'Climatology'),alpha = 1)+
    geom_line(data = ERA_NWP_raw_loss[lead_time <121, mean(raw_loss_09), by = lead_time], aes(x = lead_time, y = V1, col = 'NWP'),alpha = 1)+
    geom_line(data = ERA_NWP_RQE1[date>=as.Date("2007-01-01") & lead_time>60 & lead_time<=120, .(mean_test_loss = mean(mean_loss_1_19)), keyby = lead_time], aes(x = lead_time, y = mean_test_loss, col = 'K19'),alpha = 1)+
    ylim(2, 12.1)+
