...
```{r}
save(No_inter_1, file = paste0(path, 'No_inter_1.Rda'))
save(No_inter_2, file = paste0(path, 'No_inter_2.Rda'))
save(No_inter_3, file = paste0(path, 'No_inter_3.Rda'))
save(No_inter_4, file = paste0(path, 'No_inter_4.Rda'))
save(No_inter_5, file = paste0(path, 'No_inter_5.Rda'))
save(No_inter_6, file = paste0(path, 'No_inter_6.Rda'))
save(No_inter_7, file = paste0(path, 'No_inter_7.Rda'))
save(No_inter_8, file = paste0(path, 'No_inter_8.Rda'))
save(Mean_temp1, file = paste0(path, 'Mean_temp1.Rda'))
save(Mean_temp2, file = paste0(path, 'Mean_temp2.Rda'))
```
...
save(Factor10_inter1_3, file = 'Factor10_inter1_3.Rda')
save(Factor10_inter1_3b, file = 'Factor10_inter1_3b.Rda')
save(Factor10_inter1_4, file = 'Factor10_inter1_4.Rda')
save(Factor10_inter1_5, file = 'Factor10_inter1_5.Rda')

save(Factor10_inter1, file = 'Factor10_inter1.Rda')
...
Factor10_inter1_3 = demand_forecast(X_mat, date_demand,forc_start = '2016-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 3,  reg_form = "volume ~ as.factor(hour):as.factor(week)  + as.factor(w_day):as.factor(week) + s(week) + s(month) + season1 + season2 + year", cores = 48, custom = 's(PC1)+s(PC2)+s(PC3)', no_pc = FALSE) #DONE


Factor10_inter1_4 = demand_forecast(X_mat, date_demand,forc_start = '2016-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 4,  reg_form = "volume ~ as.factor(hour):as.factor(week)  + as.factor(w_day):as.factor(week) + s(week) + s(month) + season1 + season2 + year", cores = 48, custom = 's(PC1)+s(PC2)+s(PC3)+s(PC4)', no_pc = FALSE) #DONE


Factor10_inter1_5 = demand_forecast(X_mat, date_demand,forc_start = '2016-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 5,  reg_form = "volume ~ as.factor(hour):as.factor(week)  + as.factor(w_day):as.factor(week) + s(week) + s(month) + season1 + season2 + year", cores = 48, custom = 's(PC1)+s(PC2)+s(PC3)+s(PC4)+s(PC5)', no_pc = FALSE) #ERROR -redo

Factor10_inter1_6 = demand_forecast(X_mat, date_demand,forc_start = '2016-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 6,  reg_form = "volume ~ as.factor(hour):as.factor(week)  + as.factor(w_day):as.factor(week) + s(week) + s(month) + season1 + season2 + year", cores = 48, custom = 's(PC1)+s(PC2)+s(PC3)+s(PC4)+s(PC5)+s(PC6)')
