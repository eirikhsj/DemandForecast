...
date_demand[,season1 := cos(2*pi * season/4) ]
date_demand[,season2 := sin(2*pi * season/4) ]
...
lines(Wday6$Result[,sqrt(mean((volume - pred_1)^2)), keyby = init_date])
