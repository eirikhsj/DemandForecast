...
```{r, eval = FALSE}
Naive= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                        p_comps = 0,  reg_form = "volume ~ hour + season + w_day + week + month + year")
```

```{r, eval = FALSE}
Combo1= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour):season + as.factor(season) + as.factor(w_day):season + week1 + week2 + month1 + month2 + year")

Combo2= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour):season + as.factor(season) + as.factor(w_day):season + week1 + week2 + month + year")

Combo3= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(hour, by = season) + as.factor(season) + as.factor(w_day):season + week1 + week2 + month1 + month2 + year")

Combo4= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour):season + as.factor(season) + as.factor(w_day):season + s(week1) + s(week2) + month + year")

Combo5= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
Combo5b= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour):as.factor(season) + as.factor(season) + s(week1) + s(week2) + month + year") 

Combo5c= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour):as.factor(season) + as.factor(w_day):as.factor(season)+ s(week1) + s(week2) + month + year") 

Combo5d= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                        p_comps = 0,  reg_form = "volume ~ as.factor(hour)+ as.factor(season) + as.factor(w_day):as.factor(season) + s(week1) + s(week2) + month + year")  

Combo6= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
Baseline5= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + month + year")

Baseline_old= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + as.factor(week) + year")

Best = demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r}
Best_inter1 = demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r}
Best_inter2= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r}
Best_inter3 = demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r}
Best_inter4 = demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r}
Best_inter5 = demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 6,  reg_form = "volume ~ as.factor(hour):as.factor(season) + as.factor(season) + as.factor(w_day):as.factor(season) + s(week1) + s(week2) + month + year", custom = 's(PC1) + s(PC2) + s(PC5)')
```
...
```{r, eval = FALSE}
Baseline1 = demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + as.factor(month) + year")

Baseline2= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + month1 + month2 + year")

Baseline3= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + year")

Baseline4= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + month1 + month2 + year")

Baseline5= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + month + year")

Baseline6= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r, eval = FALSE}
Baseline1 = demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 10, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + as.factor(month) + year")
...
Baseline2= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 10, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + month1 + month2 + year")
...
Baseline3= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 10, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + year")
...
Baseline4= demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 10, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + month1 + month2 + year")
...
```{r, eval = FALSE}
Eight_pca = demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r, eval = FALSE}
Three_pca = demand_forecast(X_mat, date_demand,forc_start = '2014-01-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
