...
# 1) Climatology
```{r}
Climatology = demand_forecast(forc_start = ' 2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ 1", incl_climatology = TRUE)
```
...
Year1 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ year", incl_climatology = FALSE)
Year2 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(year)", incl_climatology = FALSE)
```
