...
This document tries to find the best baseline model to predict the demand volume in problem 1 of the thesis. 
...
# 2) Single covariates
```{r, eval = FALSE}
Year1 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ year")
Year2 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(year)")
```

```{r, eval = FALSE}
Wday1 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ w_day")
Wday2 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(w_day)")
Wday3 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ w_day1 + w_day2")
Wday4 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(w_day):season")
Wday5 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(w_day):month")
```


```{r, eval = FALSE}
Week1 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ week")
Week2 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(week)")
Week3 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(week)")
Week4 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ week1 + week2")
Week5 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(week1) + s(week2)")
Week6 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ week1:season + week2:season")
Week7 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(week1, by = season) + s(week2, by = season)")
```


```{r, eval = FALSE}
Month1 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ month")
Month2 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(month)")
Month3 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(month)")
Month4 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ month1 + month2")
Month5 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(month1) + s(month2)")  #why doesnt this work
Month6 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(month, by = season)")  
Month7 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(month, bs = 'cc', k = 12)")  

```

```{r, eval = FALSE}
Hour1 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ hour")
Hour2 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(hour)")
Hour2 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(hour, by = season)")
Hour3 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour)")  #Best
Hour4 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ hour1 + hour2")
Hour5 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(hour1) + s(hour2)")
Hour6 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(hour, by = season)")
Hour7 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(hour, by = month)")
Hour8 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(hour, by = week)")
Hour9 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(hour1, by = season) + s(hour2, by = season)")
Hour10 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour):season")
Hour11 = demand_forecast(forc_start = '2014-02-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour):as.factor(month)")
```

### Save models
```{r, eval = FALSE}
save(Hour1, file = 'model_output_best_baseline/Hour1.Rda')
save(Hour2, file = 'model_output_best_baseline/Hour2.Rda')
save(Hour3, file = 'model_output_best_baseline/Hour3.Rda')
save(Hour4, file = 'model_output_best_baseline/Hour4.Rda')
save(Hour5, file = 'model_output_best_baseline/Hour5.Rda')
save(Hour6, file = 'model_output_best_baseline/Hour6.Rda')
save(Hour7, file = 'model_output_best_baseline/Hour7.Rda')
save(Hour8, file = 'model_output_best_baseline/Hour8.Rda')
save(Hour9, file = 'model_output_best_baseline/Hour9.Rda')
save(Hour10, file = 'model_output_best_baseline/Hour10.Rda')

save(Week1, file = 'model_output_best_baseline/Week1.Rda')
save(Week2, file = 'model_output_best_baseline/Week2.Rda')
save(Week3, file = 'model_output_best_baseline/Week3.Rda')
save(Week4, file = 'model_output_best_baseline/Week4.Rda')
save(Week5, file = 'model_output_best_baseline/Week5.Rda')
save(Week6, file = 'model_output_best_baseline/Week6.Rda')
save(Week7, file = 'model_output_best_baseline/Week7.Rda')

save(Month1, file = 'model_output_best_baseline/Month1.Rda')
save(Month2, file = 'model_output_best_baseline/Month2.Rda')
save(Month3, file = 'model_output_best_baseline/Month3.Rda')
save(Month4, file = 'model_output_best_baseline/Month4.Rda')
#save(Month5, file = 'model_output_best_baseline/Month5.Rda')
save(Month6, file = 'model_output_best_baseline/Month6.Rda')
save(Month7, file = 'model_output_best_baseline/Month6.Rda')

save(Year1, file = 'model_output_best_baseline/Year1.Rda')
save(Year2, file = 'model_output_best_baseline/Year2.Rda')

save(Wday1, file = 'model_output_best_baseline/Wday1.Rda')
save(Wday2, file = 'model_output_best_baseline/Wday2.Rda')
save(Wday3, file = 'model_output_best_baseline/Wday3.Rda')
save(Wday4, file = 'model_output_best_baseline/Wday4.Rda')
save(Wday5, file = 'model_output_best_baseline/Wday5.Rda')

```

```{r, cache = TRUE}
load(file = 'model_output_best_baseline/Hour1.Rda')
load(file = 'model_output_best_baseline/Hour2.Rda')
load(file = 'model_output_best_baseline/Hour3.Rda')
load(file = 'model_output_best_baseline/Hour4.Rda')
load(file = 'model_output_best_baseline/Hour5.Rda')
load(file = 'model_output_best_baseline/Hour6.Rda')
load(file = 'model_output_best_baseline/Hour7.Rda')
load(file = 'model_output_best_baseline/Hour8.Rda')
load(file = 'model_output_best_baseline/Hour9.Rda')
load(file = 'model_output_best_baseline/Hour10.Rda')

load(file = 'model_output_best_baseline/Week1.Rda')
load(file = 'model_output_best_baseline/Week2.Rda')
load(file = 'model_output_best_baseline/Week3.Rda')
load(file = 'model_output_best_baseline/Week4.Rda')
load(file = 'model_output_best_baseline/Week5.Rda')
load(file = 'model_output_best_baseline/Week6.Rda')
load(file = 'model_output_best_baseline/Week7.Rda')

load(file = 'model_output_best_baseline/Month1.Rda')
load(file = 'model_output_best_baseline/Month2.Rda')
load(file = 'model_output_best_baseline/Month3.Rda')
load(file = 'model_output_best_baseline/Month4.Rda')
#load(file = 'model_output_best_baseline/Month5.Rda')
load(file = 'model_output_best_baseline/Month6.Rda')
load(file = 'model_output_best_baseline/Month7.Rda')

load(file = 'model_output_best_baseline/Year1.Rda')
load(file = 'model_output_best_baseline/Year2.Rda')

load(file = 'model_output_best_baseline/Wday1.Rda')
load(file = 'model_output_best_baseline/Wday2.Rda')
load(file = 'model_output_best_baseline/Wday3.Rda')
load(file = 'model_output_best_baseline/Wday4.Rda')
load(file = 'model_output_best_baseline/Wday5.Rda')
...
```{r, eval = FALSE}
Naive= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                        p_comps = 0,  reg_form = "volume ~ hour + season + w_day + week + month + year")
```

```{r, eval = FALSE}
Combo1= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour):season + as.factor(season) + as.factor(w_day):season + week1 + week2 + month1 + month2 + year")

Combo2= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour):season + as.factor(season) + as.factor(w_day):season + week1 + week2 + month + year")

Combo3= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ s(hour, by = season) + as.factor(season) + as.factor(w_day):season + week1 + week2 + month1 + month2 + year")

Combo4= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour):season + as.factor(season) + as.factor(w_day):season + s(week1) + s(week2) + month + year")

Combo5= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
Combo5b= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour):as.factor(season) + as.factor(season) + s(week1) + s(week2) + month + year") 

Combo5c= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour):as.factor(season) + as.factor(w_day):as.factor(season)+ s(week1) + s(week2) + month + year") 

Combo5d= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                        p_comps = 0,  reg_form = "volume ~ as.factor(hour)+ as.factor(season) + as.factor(w_day):as.factor(season) + s(week1) + s(week2) + month + year")  

Combo6= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
Baseline5= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + month + year")

Baseline_old= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + as.factor(week) + year")

Best = demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
#Best2 = demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r, eval = FALSE}
save(Naive, file = 'model_output_best_baseline/Naive.Rda')
save(Combo1, file = 'model_output_best_baseline/Combo1.Rda')
save(Combo2, file = 'model_output_best_baseline/Combo2.Rda')
save(Combo3, file = 'model_output_best_baseline/Combo3.Rda')
save(Combo4, file = 'model_output_best_baseline/Combo4.Rda')
save(Combo5, file = 'model_output_best_baseline/Combo5.Rda')
save(Combo6, file = 'model_output_best_baseline/Combo6.Rda')
save(Best, file = 'model_output_best_baseline/Best.Rda')
save(Best2_comb, file = 'model_output_best_baseline/Best2_comb.Rda')


save(Baseline5, file = 'model_output_best_baseline/Baseline5.Rda')
save(Baseline_old, file = 'model_output_best_baseline/Baseline_old.Rda')
```

```{r, cache=TRUE}
load(file = 'model_output_best_baseline/Combo1.Rda')
load(file = 'model_output_best_baseline/Combo2.Rda')
load(file = 'model_output_best_baseline/Combo3.Rda')
load(file = 'model_output_best_baseline/Combo4.Rda')
load(file = 'model_output_best_baseline/Combo5.Rda')
load(file = 'model_output_best_baseline/Combo6.Rda')
load(file = 'model_output_best_baseline/Best.Rda')
load(file = 'model_output_best_baseline/Best2.Rda')

load(file = 'model_output_best_baseline/Baseline5.Rda')
load(file = 'model_output_best_baseline/Baseline_old.Rda')
```
...
```{r}
Best_inter1 = demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r}
Best_inter2= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r}
Best_inter3 = demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r}
Best_inter4 = demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r}
Best_inter5 = demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 6,  reg_form = "volume ~ as.factor(hour):as.factor(season) + as.factor(season) + as.factor(w_day):as.factor(season) + s(week1) + s(week2) + month + year", custom = 's(PC1) + s(PC2) + s(PC5)')
```
...
```{r, eval = FALSE}
Baseline1 = demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + as.factor(month) + year")

Baseline2= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + month1 + month2 + year")

Baseline3= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + year")

Baseline4= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + month1 + month2 + year")

Baseline5= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + month + year")

Baseline6= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r, eval = FALSE}
Baseline1 = demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 10, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + as.factor(month) + year")
...
Baseline2= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 10, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + month1 + month2 + year")
...
Baseline3= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 10, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + year")
...
Baseline4= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 10, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + month1 + month2 + year")
...
Baseline5= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 10, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + month + year")
...
Baseline6= demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 10, 
                    p_comps = 0,  reg_form = "volume ~ hour1 + hour2 + week1 + week2 + month + year")
...
```{r, eval = FALSE}
Eight_pca = demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
...
```{r, eval = FALSE}
Eight_pca2 = demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, p_comps = 8,  reg_form = "volume ~ as.factor(hour) + week1 + week2 + month + year")
```
...
```{r, eval = FALSE}
Three_pca = demand_forecast(forc_start = '2014-01-01', forc_end = '2021-09-01', pred_win = 30, pred_lag = 15, train_y = 5, 
