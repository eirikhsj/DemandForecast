...
p_comps = 0;  reg_form = "volume ~ as.factor(hour) + as.factor(month) + year"; custom = FALSE; incl_climatology=FALSE
```
...
Climatology = demand_forecast(forc_start = '2014-02-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5,
                              ...
                              X_mat=X_mat, date_demand = date_demand, cores = 2)
```
...
# 2) Single covariates
```{r, eval = FALSE}
Year1 = demand_forecast(forc_start = '2014-02-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ year", incl_climatology = FALSE,X_mat=X_mat, date_demand = date_demand)
Year2 = demand_forecast(forc_start = '2014-02-01', forc_end = '2023-01-01', pred_win = 30, pred_lag = 15, train_y = 5, 
                    p_comps = 0,  reg_form = "volume ~ as.factor(year)", incl_climatology = FALSE,X_mat=X_mat, date_demand = date_demand)
```
