...
Mod_9_60_climatology$Results[, group1 := lead_time%/%4]
Mod_9_60_climatology$Results[, c("PC_1days", "mean1days"):= .(mean(PC1),  mean(clima_pred)), by = .(group1, init_date)]
Mod_9_60_climatology$Results[, loss1days := pinball_loss(0.9, mean1days,PC_1days)]

Mod_9_60_NWP1$Results[, group1 := lead_time%/%4]
Mod_9_60_NWP1$Results[, c("PC_1days", "mean1days"):= .(mean(PC1),  mean(pred)), by = .(group1, init_date)]
Mod_9_60_NWP1$Results[, loss1days := pinball_loss(0.9, mean1days,PC_1days)]
plot(Mod_9_60_NWP1$Results[, mean(loss1days), by = group], type = 'l', ylim = c(0, 12))
lines(Mod_9_60_climatology$Results[, mean(loss1days), by = group], col = 'red')

#Making interval groups 2-days
Mod_9_60_climatology$Results[, group2 := lead_time%/%8]
Mod_9_60_climatology$Results[, c("PC_2days", "mean2days"):= .(mean(PC1),  mean(clima_pred)), by = .(group2, init_date)]
Mod_9_60_climatology$Results[, loss2days := pinball_loss(0.9, mean2days,PC_2days)]

Mod_9_60_NWP1$Results[, group2 := lead_time%/%8]
Mod_9_60_NWP1$Results[, c("PC_2days", "mean2days"):= .(mean(PC1),  mean(pred)), by = .(group2, init_date)]
Mod_9_60_NWP1$Results[, loss2days := pinball_loss(0.9, mean2days,PC_2days)]
plot(Mod_9_60_NWP1$Results[, mean(loss2days), by = group], type = 'l', ylim = c(0, 12))
lines(Mod_9_60_climatology$Results[, mean(loss2days), by = group], col = 'red')


#Making interval groups 4-days
Mod_9_60_climatology$Results[, group4 := lead_time%/%16]
Mod_9_60_climatology$Results[, c("PC_4days", "mean4days"):= .(mean(PC1),  mean(clima_pred)), by = .(group4, init_date)]
Mod_9_60_climatology$Results[, loss4days := pinball_loss(0.9, mean4days,PC_4days)]

Mod_9_60_NWP1$Results[, group4 := lead_time%/%16]
Mod_9_60_NWP1$Results[, c("PC_4days", "mean4days"):= .(mean(PC1),  mean(pred)), by = .(group4, init_date)]
Mod_9_60_NWP1$Results[, loss4days := pinball_loss(0.9, mean4days,PC_4days)]
plot(Mod_9_60_NWP1$Results[, mean(loss4days), by = group4], type = 'l', ylim = c(0, 12))
lines(Mod_9_60_climatology$Results[, mean(loss4days), by = group4], col = 'red')



#Making interval groups 8-days
Mod_9_60_climatology$Results[, group8 := lead_time%/%32]
Mod_9_60_climatology$Results[, c("PC_8days", "mean8days"):= .(mean(PC1),  mean(clima_pred)), by = .(group8, init_date)]
Mod_9_60_climatology$Results[, loss8days := pinball_loss(0.9, mean8days,PC_8days)]

Mod_9_60_NWP1$Results[, group8 := lead_time%/%32]
Mod_9_60_NWP1$Results[, c("PC_8days", "mean8days"):= .(mean(PC1),  mean(pred)), by = .(group8, init_date)]
Mod_9_60_NWP1$Results[, loss8days := pinball_loss(0.9, mean8days,PC_8days)]
plot(Mod_9_60_NWP1$Results[, mean(loss8days), by = group8], type = 'l', ylim = c(0, 12))
lines(Mod_9_60_climatology$Results[, mean(loss8days), by = group8], col = 'red')

#Making interval groups 16-days
Mod_9_60_climatology$Results[, group16 := lead_time%/%64]
Mod_9_60_climatology$Results[, c("PC_16days", "mean16days"):= .(mean(PC1),  mean(clima_pred)), by = .(group16, init_date)]
Mod_9_60_climatology$Results[, loss16days := pinball_loss(0.9, mean16days,PC_16days)]

Mod_9_60_NWP1$Results[, group16 := lead_time%/%64]
Mod_9_60_NWP1$Results[, c("PC_16days", "mean16days"):= .(mean(PC1),  mean(pred)), by = .(group16, init_date)]
Mod_9_60_NWP1$Results[, loss16days := pinball_loss(0.9, mean16days,PC_16days)]
plot(Mod_9_60_NWP1$Results[, mean(loss16days), by = group16], type = 'l', ylim = c(0, 12))
lines(Mod_9_60_climatology$Results[, mean(loss16days), by = group16], col = 'red')

#Making interval groups 32-days
Mod_9_60_climatology$Results[, group32 := lead_time%/%128]
Mod_9_60_climatology$Results[, c("PC_32days", "mean32days"):= .(mean(PC1),  mean(clima_pred)), by = .(group32, init_date)]
Mod_9_60_climatology$Results[, loss32days := pinball_loss(0.9, mean32days,PC_32days)]

Mod_9_60_NWP1$Results[, group32 := lead_time%/%128]
Mod_9_60_NWP1$Results[, c("PC_32days", "mean32days"):= .(mean(PC1),  mean(pred)), by = .(group32, init_date)]
Mod_9_60_NWP1$Results[, loss32days := pinball_loss(0.9, mean32days,PC_32days)]
plot(Mod_9_60_NWP1$Results[, mean(loss32days), by = group32], type = 'l', ylim = c(0, 12))
lines(Mod_9_60_climatology$Results[, mean(loss32days), by = group32], col = 'red')


plot(1 - (Mod_9_60_NWP1$Results[,mean(test_loss), by = lead_time][,V1]/
              Mod_9_60_climatology$Results[,mean(clima_loss), by = lead_time][,V1]),
              type = 'l',col = 'black', ylim = c(-0.05, 0.6), main = "Skill by Period")
lines(rep(1 - (Mod_9_60_NWP1$Results[,mean(loss1days), by = group1][,V1]/
              Mod_9_60_climatology$Results[,mean(loss1days), by = group1][,V1]), each = 4),col = 'grey')
abline(h = 0)
lines(rep(1 - (Mod_9_60_NWP1$Results[,mean(loss2days), by = group2][,V1]/
               Mod_9_60_climatology$Results[,mean(loss2days), by = group2][,V1]), each = 8), col = 'grey')
lines(rep(1-(Mod_9_60_NWP1$Results[,mean(loss4days), by = group4][,V1]/
              Mod_9_60_climatology$Results[,mean(loss4days), by = group4][,V1]), each = 16), col = 'grey')
lines(rep(1 - (Mod_9_60_NWP1$Results[,mean(loss8days), by = group8][,V1]/
              Mod_9_60_climatology$Results[,mean(loss8days), by = group8][,V1]), each = 32),col = 'red')
lines(rep(1 - (Mod_9_60_NWP1$Results[,mean(loss16days), by = group16][,V1]/
              Mod_9_60_climatology$Results[,mean(loss16days), by = group16][,V1]),each = 64),col = 'blue')
lines(rep(1 - (Mod_9_60_NWP1$Results[,mean(loss32days), by = group32][,V1]/
              Mod_9_60_climatology$Results[,mean(loss32days), by = group32][,V1]),each = 128),col = 'orange')
legend("topright", lty = 1, cex = 1, pch = 16, col = c('black','grey','grey','grey', 'red', 'blue', 'orange'), legend = c("6-hour", "Daily", "2 days", "4 days","8 days", "16 days", "32 days"))
```
