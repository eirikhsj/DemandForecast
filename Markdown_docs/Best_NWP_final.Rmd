...
plot_func(c('Mod_9_60_climatology','Mod_9_60_NWP1', 'Mod_9_60_NWP2'), 
          title = 'Climatology + NWP1 + NWP2', climatology_ref = TRUE,lead_time_interval = c(1,80))
...
plot_func(c('Mod_9_60_comb_a_0','Mod_9_60_comb_a_1', 'Mod_9_60_comb_a_2'), 
          title = 'Time combo + NWP1 + NWP2', climatology_ref = FALSE,legend_input= c('Time covariates', '+ 1 NWP', '+ 2 NWP'),lead_time_interval = c(161,240))
...
plot_func(c('Mod_9_60_climatology', 'Mod_9_60_comb_int_c_0','Mod_9_60_comb_int_c_1', 'Mod_9_60_comb_int_c_2'), 
          title = 'Interaction hour:week + NWP1 + NWP2', climatology_ref = TRUE,lead_time_interval = c(161,240))
...
plot_func(c('Mod_9_60_climatology', 'Mod_9_60_comb_int_b_0','Mod_9_60_comb_int_b_1', 'Mod_9_60_comb_int_b_2'), 
          title = 'Interaction hour:month + NWP1 + NWP2', climatology_ref = TRUE,lead_time_interval = c(161,240))
...
scp eirikhsj@abacus-as.uio.no:~/Factor10_inter1.Rda eirikhsj@abacus-as.uio.no:~/Factor10_inter1_2.Rda eirikhsj@abacus-as.uio.no:~/Factor10_inter1_3.Rda eirikhsj@abacus-as.uio.no:~/Factor10_inter1_4.Rda eirikhsj@abacus-as.uio.no:~/Factor10_inter1_5.Rda eirikhsj@abacus-as.uio.no:~/Factor10_inter1_7.Rda eirikhsj@abacus-as.uio.no:~/Factor10_inter1_8.Rda /Users/Eirik/Desktop/Master2023/Output_data/
