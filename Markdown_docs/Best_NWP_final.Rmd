...
# Splines
```{r}
Interval_Mod_9_125_NWP1_32day_spl3 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, 1, model = 'spline', window = 125, cores = 48, formula  = 'PC1 ~ -1', interval_k = 32*4, df_spline = 3)
Interval_Mod_9_125_NWP1_32day_spl4 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, 1, model = 'spline', window = 125, cores = 48, formula  = 'PC1 ~ -1', interval_k = 32*4, df_spline = 4)
Interval_Mod_9_125_NWP1_32day_spl6 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, 1, model = 'spline', window = 125, cores = 48, formula  = 'PC1 ~ -1', interval_k = 32*4, df_spline = 6)
Interval_Mod_9_125_NWP1_32day_spl8 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, 1, model = 'spline', window = 125, cores = 48, formula  = 'PC1 ~ -1', interval_k = 32*4, df_spline = 8)
Interval_Mod_9_125_NWP1_32day_spl10 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, 1, model = 'spline', window = 125, cores = 48, formula  = 'PC1 ~ -1', interval_k = 32*4, df_spline = 10)
Interval_Mod_9_125_NWP1_32day_spl12 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, 1, model = 'spline', window = 125, cores = 48, formula  = 'PC1 ~ -1', interval_k = 32*4, df_spline = 12)
Interval_Mod_9_125_NWP1_32day_spl15 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, 1, model = 'spline', window = 125, cores = 48, formula  = 'PC1 ~ -1', interval_k = 32*4, df_spline = 15)
Interval_Mod_9_125_NWP1_32day_spl20 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, 1, model = 'spline', window = 125, cores = 48, formula  = 'PC1 ~ -1', interval_k = 32*4, df_spline = 20)
Interval_Mod_9_125_NWP1_32day_spl25 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, 1, model = 'spline', window = 125, cores = 48, formula  = 'PC1 ~ -1', interval_k = 32*4, df_spline = 25)
Interval_Mod_9_125_NWP1_32day_spl30 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, 1, model = 'spline', window = 125, cores = 48, formula  = 'PC1 ~ -1', interval_k = 32*4, df_spline = 30)
Interval_Mod_9_125_NWP1_32day_spl40 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, 1, model = 'spline', window = 125, cores = 48, formula  = 'PC1 ~ -1', interval_k = 32*4, df_spline = 40)
...
copula_mod_1 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 1)
copula_mod_2 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 2)
copula_mod_4 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 4)
copula_mod_8 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 8)
copula_mod_16 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 16)
copula_mod_32 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 32)
copula_mod_564 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 64)
copula_mod_125 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 125)
```

scp eirikhsj@abacus-as.uio.no:~/copula_mod_1_1000.Rda eirikhsj@abacus-as.uio.no:~/copula_mod_2_1000.Rda  eirikhsj@abacus-as.uio.no:~/copula_mod_4_1000.Rda  eirikhsj@abacus-as.uio.no:~/copula_mod_8_1000.Rda  eirikhsj@abacus-as.uio.no:~/copula_mod_15_1000.Rda  eirikhsj@abacus-as.uio.no:~/copula_mod_30_1000.Rda eirikhsj@abacus-as.uio.no:~/copula_mod_60_1000.Rda  /Users/Eirik/Desktop/Master2023/Output_data/Copula_model_output
