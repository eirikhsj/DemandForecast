...
for (i in c(1:9)){
    ...
    print(c(Clima[lead_time %in% 1:240, mean(pinball_loss(i/10, get(paste0("clima_pred",i*10)), PC1))],
              ERA_NWP_raw_loss[lead_time %in% 1:240, mean(pinball_loss(i/10, get(paste0("NWP_PC1_q",i,"0")), PC1))]))
    print(c(
        ...
        1 - (ERA_NWP_raw_loss[lead_time %in% 1:240, mean(pinball_loss(i/10, get(paste0("NWP_PC1_q",i,"0")), PC1))]/Clima[lead_time %in% 1:240, mean(pinball_loss(i/10, get(paste0("clima_pred",i*10)), PC1))])))
...
```{r}
for (i in c(3,4,5,6,8,10,12,15,20,25,30,40)){
...
Interval_Mod_9_125_NWP1_32day_int_h_lin = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ NWP1_90:as.factor(hour)', interval_k = 32*4)
# Interval_Mod_9_125_NWP1_32day_int_w_lin = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ NWP1_90:as.factor(week)', interval_k = 32*4)
# Interval_Mod_9_125_NWP1_32day_int_m_lin = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ NWP1_90:as.factor(month)', interval_k = 32*4)
# Interval_Mod_9_125_NWP1_32day_int_s_lin = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ NWP1_90:as.factor(season)', interval_k = 32*4)
# Interval_Mod_9_125_NWP1_32day_int_y_lin = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ NWP1_90:as.factor(year)', interval_k = 32*4)

# df = 3
Interval_Mod_9_125_NWP1_32day_int_h_3 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =3):as.factor(hour)', interval_k = 32*4)
Interval_Mod_9_125_NWP1_32day_int_w_3 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =3):as.factor(week)', interval_k = 32*4)
Interval_Mod_9_125_NWP1_32day_int_m_3 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =3):as.factor(month)', interval_k = 32*4)
Interval_Mod_9_125_NWP1_32day_int_s_3 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =3):as.factor(season)', interval_k = 32*4)
Interval_Mod_9_125_NWP1_32day_int_y_3 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =3):as.factor(year)', interval_k = 32*4)

# df = 5
Interval_Mod_9_125_NWP1_32day_int_h_5 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =5):as.factor(hour)', interval_k = 32*4)
Interval_Mod_9_125_NWP1_32day_int_w_5 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =5):as.factor(week)', interval_k = 32*4)
Interval_Mod_9_125_NWP1_32day_int_m_5 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =5):as.factor(month)', interval_k = 32*4)
Interval_Mod_9_125_NWP1_32day_int_s_5 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =5):as.factor(season)', interval_k = 32*4)
Interval_Mod_9_125_NWP1_32day_int_y_5 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =5):as.factor(year)', interval_k = 32*4)

# df = 8
Interval_Mod_9_125_NWP1_32day_int_h_8 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =8):as.factor(hour)', interval_k = 32*4)
Interval_Mod_9_125_NWP1_32day_int_w_8 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =8):as.factor(week)', interval_k = 32*4)
Interval_Mod_9_125_NWP1_32day_int_m_8 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =8):as.factor(month)', interval_k = 32*4)
Interval_Mod_9_125_NWP1_32day_int_s_8 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =8):as.factor(season)', interval_k = 32*4)
Interval_Mod_9_125_NWP1_32day_int_y_8 = rolling_mod_NWP_interval('2007-01-01', '2023-01-31', 0.9, ERA_NWP, model = 'qreg', window = 125, cores = 48, formula  = 'PC1 ~ bs(NWP1_90, df =8):as.factor(year)', interval_k = 32*4)

save(Interval_Mod_9_125_NWP1_32day_int_h_lin, file = "Interval_Mod_9_125_NWP1_32day_int_h_lin.Rda")

```


```{r}
for (i in c('h', 'w', 'm', 's', 'y')){
    for(type in c(3,5,8,'lin')){
        mode_name = paste0("Interval_Mod_9_125_NWP1_32day_int_",i,"_",type)
        mod = get(mode_name)
        print(c(i, type))
        print(c(mod$Results[lead_time <240 ,mean(test_loss)]))
    }
}
```
