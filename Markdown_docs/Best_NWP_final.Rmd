...
copula_mod_4 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 1)
copula_mod_4 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 2)
...
copula_mod_4 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 8)
copula_mod_4 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 16)
copula_mod_4 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 32)
copula_mod_4 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 64)
copula_mod_4 = rolling_mod_NWP_copula(as.Date('2007-01-01'), as.Date('2023-01-01'), 0.9, ERA_NWP, model = 'copula', window = 125, reweight=FALSE,formula = 'PC1 ~ NWP1_90', interval_k = 125)
```
