...
#Run models 
```{r, eval = FALSE}
M_9_60_0       = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60)
M_9_60_1       = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60)
M_9_60_2       = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60)

M_9_60_0_h     = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, hour_v = TRUE)
M_9_60_1_h     = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, hour_v = TRUE)
M_9_60_2_h     = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, hour_v = TRUE) 

M_9_60_0_w     = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, week_v = TRUE)
M_9_60_1_w     = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, week_v = TRUE)
M_9_60_2_w     = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, week_v = TRUE)

M_9_60_0_m     = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, month_v = TRUE)
M_9_60_1_m     = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, month_v = TRUE)
M_9_60_2_m     = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, month_v = TRUE) 

M_9_60_0_y     = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, year_v = TRUE)
M_9_60_1_y     = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, year_v = TRUE)
M_9_60_2_y     = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, year_v = TRUE) 

M_9_60_0_h_w   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, hour_v = TRUE, week_v = TRUE) 
M_9_60_1_h_w   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, hour_v = TRUE, week_v = TRUE)
M_9_60_2_h_w   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, hour_v = TRUE, week_v = TRUE)

M_9_60_0_h_m   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, hour_v = TRUE, month_v = TRUE)
M_9_60_1_h_m   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, hour_v = TRUE, month_v = TRUE)
M_9_60_2_h_m   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, hour_v = TRUE, month_v = TRUE)

M_9_60_0_h_y   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, hour_v = TRUE, year_v = TRUE)
M_9_60_1_h_y   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, hour_v = TRUE, year_v = TRUE)
M_9_60_2_h_y   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, hour_v = TRUE, year_v = TRUE)

M_9_60_0_w_m   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, week_v = TRUE, month_v = TRUE)
M_9_60_1_w_m   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, week_v = TRUE, month_v = TRUE)
M_9_60_2_w_m   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, week_v = TRUE, month_v = TRUE)

M_9_60_0_w_y   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, week_v = TRUE, year_v = TRUE)
M_9_60_1_w_y   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, week_v = TRUE, year_v = TRUE)
M_9_60_2_w_y   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, week_v = TRUE, year_v = TRUE)

M_9_60_0_m_y   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, month_v = TRUE, year_v = TRUE)
M_9_60_1_m_y   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, month_v = TRUE, year_v = TRUE)
M_9_60_2_m_y   = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, month_v = TRUE, year_v = TRUE)

M_9_60_0_h_w_m  = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, hour_v = TRUE, week_v = TRUE, month_v = TRUE) 
M_9_60_1_h_w_m  = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, hour_v = TRUE, week_v = TRUE, month_v = TRUE)
M_9_60_2_h_w_m  = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, hour_v = TRUE, week_v = TRUE, month_v = TRUE)

M_9_60_0_h_w_y = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, hour_v = TRUE, week_v = TRUE, year_v = TRUE)
M_9_60_1_h_w_y = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, hour_v = TRUE, week_v = TRUE, year_v = TRUE)
M_9_60_2_h_w_y = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, hour_v = TRUE, week_v = TRUE, year_v = TRUE)

M_9_60_0_h_m_y = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, hour_v = TRUE, month_v = TRUE, year_v = TRUE)
M_9_60_1_h_m_y = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, hour_v = TRUE, month_v = TRUE, year_v = TRUE)
M_9_60_2_h_m_y = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, hour_v = TRUE, month_v = TRUE, year_v = TRUE)

M_9_60_0_w_m_y = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, week_v = TRUE, month_v = TRUE, year_v = TRUE)
M_9_60_1_w_m_y = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, week_v = TRUE, month_v = TRUE, year_v = TRUE)
M_9_60_2_w_m_y = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, week_v = TRUE, month_v = TRUE, year_v = TRUE)

M_9_60_0_h_w_m_y = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 0, model = 'reg', window = 60, hour_v = TRUE, week_v = TRUE , month_v = TRUE, year_v = TRUE)
M_9_60_1_h_w_m_y = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 1, model = 'reg', window = 60, hour_v = TRUE, week_v = TRUE , month_v = TRUE, year_v = TRUE)
M_9_60_2_h_w_m_y = rolling_mod('2007-01-01', '2022-05-01', 0.9, ERA_NWP, 2, model = 'reg', window = 60, hour_v = TRUE, week_v = TRUE , month_v = TRUE, year_v = TRUE)
```


#Saved
```{r}
path = '~/Desktop/Master2023/Output_data/Best_NWP_model_output/'
#Simple
save(M_9_60_0, file = paste0(path,'M_9_60_0.Rda'))
save(M_9_60_1, file = paste0(path,'M_9_60_1.Rda'))
save(M_9_60_2, file = paste0(path,'M_9_60_2.Rda'))

#Week
save(M_9_60_0_w, file = paste0(path,'M_9_60_0_w.Rda'))
save(M_9_60_1_w, file = paste0(path,'M_9_60_1_w.Rda'))
save(M_9_60_2_w, file = paste0(path,'M_9_60_2_w.Rda'))

#Month
save(M_9_60_0_m, file = paste0(path,'M_9_60_0_m.Rda'))
save(M_9_60_1_m, file = paste0(path,'M_9_60_1_m.Rda'))
save(M_9_60_2_m, file = paste0(path,'M_9_60_2_m.Rda'))

#Hour
save(M_9_60_0_h, file = paste0(path,'M_9_60_0_h.Rda'))
save(M_9_60_1_h, file = paste0(path,'M_9_60_1_h.Rda'))
save(M_9_60_2_h, file = paste0(path,'M_9_60_2_h.Rda'))

#Year
save(M_9_60_0_y, file = paste0(path,'M_9_60_0_y.Rda'))
save(M_9_60_1_y, file = paste0(path,'M_9_60_1_y.Rda'))
save(M_9_60_2_y, file = paste0(path,'M_9_60_2_y.Rda'))

#Hour and week
save(M_9_60_0_h_w, file = paste0(path,'M_9_60_0_h_w.Rda'))
save(M_9_60_1_h_w, file = paste0(path,'M_9_60_1_h_w.Rda'))
save(M_9_60_2_h_w, file = paste0(path,'M_9_60_2_h_w.Rda'))

#Hour and month
save(M_9_60_0_h_m, file = paste0(path,'M_9_60_0_h_m.Rda'))
save(M_9_60_1_h_m, file = paste0(path,'M_9_60_1_h_m.Rda'))
save(M_9_60_2_h_m, file = paste0(path,'M_9_60_2_h_m.Rda'))

#Hour and year
save(M_9_60_0_h_y, file = paste0(path,'M_9_60_0_h_y.Rda'))
save(M_9_60_1_h_y, file = paste0(path,'M_9_60_1_h_y.Rda'))
save(M_9_60_2_h_y, file = paste0(path,'M_9_60_2_h_y.Rda'))

#Week and month
save(M_9_60_0_w_m, file = paste0(path,'M_9_60_0_w_m.Rda'))
save(M_9_60_1_w_m, file = paste0(path,'M_9_60_1_w_m.Rda'))
save(M_9_60_2_w_m, file = paste0(path,'M_9_60_2_w_m.Rda'))

#Week and year
save(M_9_60_0_w_y, file = paste0(path,'M_9_60_0_w_y.Rda'))
save(M_9_60_1_w_y, file = paste0(path,'M_9_60_1_w_y.Rda'))
save(M_9_60_2_w_y, file = paste0(path,'M_9_60_2_w_y.Rda'))

#Month and year
save(M_9_60_0_m_y, file = paste0(path,'M_9_60_0_m_y.Rda'))
save(M_9_60_1_m_y, file = paste0(path,'M_9_60_1_m_y.Rda'))
save(M_9_60_2_m_y, file = paste0(path,'M_9_60_2_m_y.Rda'))

#Hour, week and month 
save(M_9_60_0_h_w_m, file = paste0(path,'M_9_60_0_h_w_m.Rda'))
save(M_9_60_1_h_w_m, file = paste0(path,'M_9_60_1_h_w_m.Rda'))
save(M_9_60_2_h_w_m, file = paste0(path,'M_9_60_2_h_w_m.Rda'))

#Hour, week and year 
save(M_9_60_0_h_w_y, file = paste0(path,'M_9_60_0_h_w_y.Rda'))
save(M_9_60_1_h_w_y, file = paste0(path,'M_9_60_1_h_w_y.Rda'))
save(M_9_60_2_h_w_y, file = paste0(path,'M_9_60_2_h_w_y.Rda'))

#Hour, month and year 
save(M_9_60_0_h_m_y, file = paste0(path,'M_9_60_0_h_m_y.Rda'))
save(M_9_60_1_h_m_y, file = paste0(path,'M_9_60_1_h_m_y.Rda'))
save(M_9_60_2_h_m_y, file = paste0(path,'M_9_60_2_h_m_y.Rda'))

#Week, month and year 
save(M_9_60_0_w_m_y, file = paste0(path,'M_9_60_0_w_m_y.Rda'))
save(M_9_60_1_w_m_y, file = paste0(path,'M_9_60_1_w_m_y.Rda'))
save(M_9_60_2_w_m_y, file = paste0(path,'M_9_60_2_w_m_y.Rda'))

#Hour, week, month and year 
save(M_9_60_0_h_w_m_y, file = paste0(path,'M_9_60_0_h_w_m_y.Rda'))
save(M_9_60_1_h_w_m_y, file = paste0(path,'M_9_60_1_h_w_m_y.Rda'))
save(M_9_60_2_h_w_m_y, file = paste0(path,'M_9_60_2_h_w_m_y.Rda'))
```

# load
```{r, cache = TRUE}
#Simple
load(paste0(path,'M_9_60_0.Rda'))
load(paste0(path,'M_9_60_1.Rda'))
load(paste0(path,'M_9_60_2.Rda'))

#Week
load(paste0(path,'M_9_60_0_w.Rda'))
load(paste0(path,'M_9_60_1_w.Rda'))
load(paste0(path,'M_9_60_2_w.Rda'))

#Month
load(paste0(path,'M_9_60_0_m.Rda'))
load(paste0(path,'M_9_60_1_m.Rda'))
load(paste0(path,'M_9_60_2_m.Rda'))

#Hour
load(paste0(path,'M_9_60_0_h.Rda'))
load(paste0(path,'M_9_60_1_h.Rda'))
load(paste0(path,'M_9_60_2_h.Rda'))

#Year
load(paste0(path,'M_9_60_0_y.Rda'))
load(paste0(path,'M_9_60_1_y.Rda'))
load(paste0(path,'M_9_60_2_y.Rda'))

#Hour and week
load(paste0(path,'M_9_60_0_h_w.Rda'))
load(paste0(path,'M_9_60_1_h_w.Rda'))
load(paste0(path,'M_9_60_2_h_w.Rda'))

#Hour and month
load(paste0(path,'M_9_60_0_h_m.Rda'))
load(paste0(path,'M_9_60_1_h_m.Rda'))
load(paste0(path,'M_9_60_2_h_m.Rda'))

#Hour and year
load(paste0(path,'M_9_60_0_h_y.Rda'))
load(paste0(path,'M_9_60_1_h_y.Rda'))
load(paste0(path,'M_9_60_2_h_y.Rda'))

#Week and month
load(paste0(path,'M_9_60_0_w_m.Rda'))
load(paste0(path,'M_9_60_1_w_m.Rda'))
load(paste0(path,'M_9_60_2_w_m.Rda'))

#Week and year
load(paste0(path,'M_9_60_0_w_y.Rda'))
load(paste0(path,'M_9_60_1_w_y.Rda'))
load(paste0(path,'M_9_60_2_w_y.Rda'))

#Month and year
load(paste0(path,'M_9_60_0_m_y.Rda'))
load(paste0(path,'M_9_60_1_m_y.Rda'))
load(paste0(path,'M_9_60_2_m_y.Rda'))

#Hour, week and month 
load(paste0(path,'M_9_60_0_h_w_m.Rda'))
load(paste0(path,'M_9_60_1_h_w_m.Rda'))
load(paste0(path,'M_9_60_2_h_w_m.Rda'))

#Hour, week and year 
load(paste0(path,'M_9_60_0_h_w_y.Rda'))
load(paste0(path,'M_9_60_1_h_w_y.Rda'))
load(paste0(path,'M_9_60_2_h_w_y.Rda'))

#Hour, month and year 
load(paste0(path,'M_9_60_0_h_m_y.Rda'))
load(paste0(path,'M_9_60_1_h_m_y.Rda'))
load(paste0(path,'M_9_60_2_h_m_y.Rda'))

#Week, month and year 
load(paste0(path,'M_9_60_0_w_m_y.Rda'))
load(paste0(path,'M_9_60_1_w_m_y.Rda'))
load(paste0(path,'M_9_60_2_w_m_y.Rda'))

#Hour, week, month and year 
load(paste0(path,'M_9_60_0_h_w_m_y.Rda'))
load(paste0(path,'M_9_60_1_h_w_m_y.Rda'))
load(paste0(path,'M_9_60_2_h_w_m_y.Rda'))
```
...
# Looking at just the best time covariate models
```{r, cache=TRUE}
matplot(low:upp, plot_rolling0_w[low:upp,mean_test_loss], col = 'white', type = 'l', lty = 1, ylim = c(6.5,11))
...
```
# Looking at just the best PC1 models
```{r, cache = TRUE}
matplot(low:upp, plot_rolling1[low:upp,mean_test_loss], col = 'brown1', type = 'l', lty = 1, ylim = c(4,11))
...
#Looking at different prediction spans
low = 1
upp = 240
...
low = 1
upp = 240
matplot(low:upp, plot_rolling1_h[low:upp,mean_test_loss], col = 'brown1', type = 'l', lty = 1, ylim = c(4,11))
matlines(low:upp, plot_rolling1_h_m[low:upp,mean_test_loss], col = 'green', lty = 1)
matlines(low:upp, plot_rolling1_h_w[low:upp,mean_test_loss], col = 'dodgerblue1', lty = 1)
